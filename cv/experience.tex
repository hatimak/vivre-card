...
\cvposition
	...
	{\begin{cvitems}
		\item {Implemented power system models using the open-source code-generation tool ORTiS targeted towards High-Level Synthesis for real-time simulation.}
	\end{cvitems}}
%---------------------------------------------------------
...
\cvposition
	...
	{\begin{cvitems}
		...
		\item {Implemented an AXI4 memory-mapped register interface wrapper around the Aurora 8B/10B by extending the respective Xilinx Baremetal drivers.}
	\end{cvitems}}
%---------------------------------------------------------
