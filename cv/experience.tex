...
\cvExperienceTitle{EN}{M.\,Sc. Thesis\newline ``Field-Programmable Gate Array based Real-Time Control and Simulation''} % Job title
\cvExperienceTitle{DE}{Masterarbeit\newline ``Field-Programmable Gate Array basierte Echtzeitregelung und -simulation''} % Job title
