...
\cvExperienceDescription{EN}{%
	\begin{cvitems}
		\item {Worked on micro-architecture design and SystemVerilog implementation ofAdreno GPU blocks in mobile and compute tier SoC.}
%		\item {Designed and implemented micro-architecture for sub-modules of Geometry Processing Cluster of Adreno GPU in premium-tier Snapdragon SoC.}
		...
		\item {Proposed AI initiatives and built automation scripts in Python for auto-genration of SystemVerilog RTL, saving repetitive manual effort across multiple projects.}
...
% 		\item {Collaborated with cross-functional teams including verification, physical design, and architecture to ensure seamless integration of modules.}
	\end{cvitems}%
}
