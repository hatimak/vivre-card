...
\cvExperienceDescription{EN}{%
	\begin{cvitems}
		\item {Worked on micro-architecture design and SystemVerilog implementation of Adreno GPU blocks in mobile and compute tier SoC.}
%		\item {Designed and implemented micro-architecture for sub-modules of Geometry Processing Cluster of Adreno GPU in premium-tier Snapdragon SoC.}
		\item {Received appreciation for thorough and high-quality RTL designs and micro-architecture diagrams.}
		\item {Executed design cleanup tasks to improve code readability and maintainability across multiple projects.}
		\item {Proposed AI initiatives and built automation scripts in Python for auto-genration of SystemVerilog RTL, saving repetitive manual effort across multiple projects and derivatives.}
		\item {Analyzed and implemented fixes for timing improvement, power optimization, and wire count reduction.}
		\item {Supported verification effort by providing whitebox coverage RTL and formal checks for functional behaviour.}
		\item {Supported timing closure effort for max frequency push for compute-tier product lines.}
 		\item {Collaborated with cross-functional teams including verification, physical design, and architecture to ensure timely delivery of work products.}
	\end{cvitems}%
}
