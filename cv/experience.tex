...
\cvExperienceDescription{DE}{%
	\begin{cvitems}
		...
		\item {Erweiterte HLS-Modelle mit memory-mapped AXI4-Register-Schnittstellen. Verifizierte Hardware-Modelle auf Xilinx Virtex-7 VC707 FPGA-Board mit Remote-Debugging.}
