...
\cvExperienceTitle{EN}{Engineer} % Job title
...
\cvExperienceTitle{EN}{Engineer, Development of FPGA Systems} % Job title
\cvExperienceTitle{DE}{Wissenschaftliche Hilfskraft (Entwicklung von FPGA-Systeme)} % Job title

\cvExperienceOrganisation{EN}{E.ON Energy} % Organization
\cvExperienceOrganisation{DE}{} % Organization
