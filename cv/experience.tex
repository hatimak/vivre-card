...
\cvposition
	{M.Sc. Thesis \quad\textbar\quad ``Field-Programmable Gate Array based Real-Time Control and Simulation''} % Job title
...
\cvposition
	...
	{Supervisor: Dr.-Ing. Lukas Razik} % Subtitle
	{J\"ulich, Germany} % Location
...
\cvposition
	...
	{Supervisor: Steffen Vogel, M.\, Sc.} % Subtitle
	{Aachen, Germany} % Location
...
\cvposition
	...
	{Control and Instrumentation Lab, \href{https://www.iitp.ac.in}{IIT Patna}} % Location
...
%		\item {Customised and implemented a matrix inversion routine to compute covariance inverses in $\mathcal{O} \left( N \right)$ time complexity.}
		...
		\item {Presented the final work product to the professors of the department and was one of the only two students to receive a unanimous 10 / 10 grade out of a cohort of 50 students.}
	\end{cvitems}}
%---------------------------------------------------------
...
\cvposition
	...
	{Mentor: \href{http://www.jeremybennett.com}{Dr Jeremy Bennett}} % Subtitle
...
\cvposition
	...
	{\begin{cvitems} % Description(s)
		\item {Designed a unified abstraction of multiple status registers in an SPI Flash-memory chip to provide a consistent interface across diverse chip manufacturers.}
