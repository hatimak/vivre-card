...
\cvExperienceOrganisation{EN}{Forschungszentrum Juelich GmbH} % Organization
...
\cvExperienceOrganisation{DE}{E.ON Energy (Automation of Complex Power Systems)} % Organization
...
\cvExperienceOrganisation{EN}{\href{https://www.drdo.gov.in/labs-and-establishments/naval-physical-oceanographic-laboratory-npol}{Naval Physical \& Oceanographic Laboratory}} % Title
...
\cvExperienceLocation{EN}{DRDO \ifbool{showEmojis} {\space\emoji{flag-india}} {} } % Location
...
\cvExperienceDescription{EN}{%
	\begin{cvitems} % Description(s)
		\item {Designed and implemented parallel architecture for \href{https://github.com/hatimak/sigma}{``family of Sigma-Point Kalman filtering algorithms''} on FPGA.}
