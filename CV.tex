...
\location{{\faCalendar} FEB. 2017 - PRESENT \textbullet{} {\faGithub} \href{https://github.com/hatimak/zephyr}{hatimak/zephyr}}
\location{Adviser - Dr Yatendra Kumar Singh}
%\vspace{\topsep}% Hacky fix for awkward extra vertical spac
\begin{tightemize}
...
\sectionsep
%
\runsubsection{flashrom \\}
\location{{\faCalendarCheckO} FEB. - AUG. 2016}
\begin{tightemize}
\item
\end{tightemize}
\sectionsep
